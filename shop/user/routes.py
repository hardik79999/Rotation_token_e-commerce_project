...
from shop.user.api.cart import add_to_cart_action, get_cart_action
...
def toggle_wishlist_route(): return toggle_wishlist_action()

@user_bp.route('/wishlist', methods=['GET'])
def get_wishlist_route(): return get_wishlist_action()

@user_bp.route('/review', methods=['POST'])
def add_review_route(): return add_review_action()
